...
describe('Service Tests', () => {
    ...
    describe('Release_MySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(Release_MySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/release-s';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Release_MySuffix', () => {
