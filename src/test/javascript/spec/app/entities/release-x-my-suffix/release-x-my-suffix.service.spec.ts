...
describe('Service Tests', () => {
    ...
    describe('ReleaseXMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ReleaseXMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/release-xes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ReleaseXMySuffix', () => {
