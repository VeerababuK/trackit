...
describe('Service Tests', () => {
    ...
    describe('CalendarMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CalendarMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/calendars';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CalendarMySuffix', () => {
