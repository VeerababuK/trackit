...
@Injectable()
export class StoryMySuffixPopupService {
            ...
            if (id) {
                this.storyService.find(id)
                    .subscribe((storyResponse: HttpResponse<StoryMySuffix>) => {
                        const story: StoryMySuffix = storyResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.storyModalRef(component, new StoryMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    storyModalRef(component: Component, story: StoryMySuffix): NgbModalRef {
